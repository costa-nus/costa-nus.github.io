...
function Nav() {
  ...
  return (
    <div style={{
      position: 'sticky', top: 0, zIndex: 30, background: `${C.paper}ee`,
      backdropFilter: 'blur(10px)', borderBottom: `1px solid ${C.ink}16`,
    }}>
      <div style={{
...
function Hero() {
  return (
    <section id="top" style={{ background: C.paper, paddingTop: 64, paddingBottom: 96, position: 'relative', overflow: 'hidden' }}>
      ...
      <style>{`
        @keyframes costaBreathe {
          0%, 100% { transform: scale(1);   box-shadow: 0 0 0 6px ${C.accent}22, 0 0 0 18px ${C.accent}10, 0 0 0 34px ${C.accent}04; }
          50%      { transform: scale(1.12); box-shadow: 0 0 0 10px ${C.accent}2e, 0 0 0 26px ${C.accent}16, 0 0 0 46px ${C.accent}06; }
        }
        ...
        .costa-sun {
          position: absolute; right: 12%; top: 120px; width: 14px; height: 14px; border-radius: 7px;
          background: ${C.accent};
        ...
        @keyframes costaDotBreathe {
          0%, 100% { transform: scale(1);    box-shadow: 0 0 0 0.18em ${C.accent}22, 0 0 0 0.42em ${C.accent}0c; }
          50%      { transform: scale(1.15); box-shadow: 0 0 0 0.28em ${C.accent}2a, 0 0 0 0.6em  ${C.accent}12; }
        }
        .costa-dot-accent {
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', position: 'relative' }}>
        ...
        <div style={{
          ...
          {[
            ['LOCATION', 'Dept. of Electrical & Computer Engineering, NUS'],
          ].map(([k, v]) => (
            <div key={k}>
...
const PUBS = [
  { year: '2026', venue: 'ICRA', type: 'Conference', title: 'AD-VF: LLM-Automatic Differentiation Enables Fine-Tuning-Free Robot Planning from Formal Methods Feedback', tags: ['Reasoning', 'Agents'] },
  { year: '2025', venue: 'arXiv', type: 'Preprint', title: 'LLMs Can Get "Brain Rot"!', tags: ['Cognition', 'Media'] },
  { year: '2025', venue: 'COLM', type: 'Conference', title: 'SEAL: Steerable Reasoning Calibration of Large Language Models for Free', tags: ['Reasoning'] },
  { year: '2025', venue: 'COLM', type: 'Conference', title: 'LoX: Low-Rank Extrapolation Robustifies LLM Safety Against Fine-tuning', tags: ['Safety'] },
  { year: '2025', venue: 'EMNLP', type: 'Main', title: 'MedHallu: A Comprehensive Benchmark for Detecting Medical Hallucinations in LLMs', tags: ['Healthcare', 'Trust'] },
  { year: '2025', venue: 'ICML', type: 'Conference', title: 'GuardAgent: Safeguard LLM Agents by a Guard Agent via Knowledge-Enabled Reasoning', tags: ['Safety', 'Agents'] },
  { year: '2024', venue: 'VLDB', type: 'Best Paper Finalist', title: 'LLM-PBE: Assessing Data Privacy in Large Language Models', tags: ['Privacy'] },
  { year: '2024', venue: 'ICML', type: 'Conference', title: 'Decoding Compressed Trust: Scrutinizing the Trustworthiness of Efficient LLMs Under Compression', tags: ['Trust'] },
  { year: '2024', venue: 'ICLR', type: 'Spotlight', title: 'DP-OPT: Make Large Language Model Your Privacy-Preserving Prompt Engineer', tags: ['Privacy'] },
  { year: '2024', venue: 'ICLRW', type: 'Workshop', title: 'A-CONECT: Designing AI-based Conversational Chatbot for Early Dementia Intervention', tags: ['Healthcare'] },
  { year: '2023', venue: 'NeurIPS', type: 'Conference', title: 'Understanding Deep Gradient Leakage via Inversion Influence Functions', tags: ['Privacy'] },
  { year: '2023', venue: 'ICLR', type: 'Spotlight', title: 'Turning the Curse of Heterogeneity in Federated Learning into a Blessing for OoD Detection', tags: ['FL'] },
];

function Publications() {
  const [filter, setFilter] = React.useState('All');
  const tags = ['All', 'Healthcare', 'Privacy', 'Safety', 'Trust', 'Reasoning', 'Agents', 'FL'];
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
        <div style={{ maxWidth: 900, marginBottom: 56 }}>
          ...
          <div style={{
            ...
            A record of what we've charted.
          </div>
          <div style={{
            fontFamily: F.editorial, fontStyle: 'italic', fontSize: 22, lineHeight: 1.45,
            color: C.paper, opacity: 0.75, marginTop: 20, maxWidth: 720, textWrap: 'pretty',
          }}>
            Selected publications from <i>NeurIPS, ICLR, ICML, COLM, VLDB, KDD, AAAI, EMNLP, NAACL</i> — full list on the PI's page.
          </div>
        </div>
...
function PubRow({ p }) {
  const highlight = /(Spotlight|Best Paper|Finalist)/i.test(p.type);
  return (
    <div style={{
      display: 'grid', gridTemplateColumns: '100px 160px 1fr 200px', gap: 24,
      ...
      <div>
        <div style={{ fontFamily: F.display, fontWeight: 600, fontSize: 15, color: C.paper }}>{p.venue}</div>
        <div style={{
  ...
  return (
    <section id="people" style={{ background: C.paper, padding: '120px 0' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
        ...
        <div style={{ height: 80 }} />
        <MonoLabel size={10}>Alumni — where they are now</MonoLabel>
  ...
  return (
    <footer style={{ background: C.paper, padding: '72px 0 48px', borderTop: `1px solid ${C.ink}1a` }}>
      <div style={{
        ...
        {[
          ['Lab', [['Research', '#research'], ['Publications', '#publications'], ['People', '#people'], ['News', '#news']]],
          ['Connect', [
            ['Join →', '#join'],
...
Object.assign(window, {
  Nav, Hero, PIIntro, ResearchPillars, Publications, People, News, Join, Footer, C, F,
});
